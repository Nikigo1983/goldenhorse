...
export default function DmitryLuchanovWorksPage() {
    ...
    <>
      <section className="section page-section artist-works-page">
        ...
        <nav className="artist-detail-tabs">
          <Link href="/artists/dmitry-luchanov">Biography</Link>
        ...
        <div id="works" className="artist-works-header">
          <h2>PAINTING</h2>
          <p>
            <Link href="/artworks" className="artist-works-view-all-link">
              View all categories
            </Link>
          </p>
        </div>
